...
public class JobTitleSteps extends CommonMethods {
    ...
    @When("user clicks on the job button")
    public void user_clicks_on_the_job_button() {
        click(adminDashBoardPage.adminJobBtn);
    }

    @When("user clicks on the job Titles button")
    public void user_clicks_on_the_job_titles_button() {
    ...
    public void user_clicks_on_the_add_button() {
        click(adminDashBoardPage.addJobBtn);
    }
